...
<div class="item_fields">
	...
	<table class="table">
		...
		<tr>
			<th><?php echo JText::_('COM_GUITAR_FORM_LBL_GUITARIST_NAME'); ?></th>
...
<?php if($canEdit && $this->item->checked_out == 0): ?>
	...
	<a class="btn" href="<?php echo JRoute::_('index.php?option=com_guitar&task=guitarist.edit&id='.$this->item->id); ?>"><?php echo JText::_("COM_GUITAR_EDIT_ITEM"); ?></a>

<?php endif; ?>

<?php if (JFactory::getUser()->authorise('core.delete','com_guitar.guitarist.'.$this->item->id)) : ?>
	...
	<div id="deleteModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="deleteModal" aria-hidden="true">
		...
		<div class="modal-footer">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_guitar&task=guitarist.remove&id=' . $this->item->id, false, 2); ?>" class="btn btn-danger">
				<?php echo JText::_('COM_GUITAR_DELETE_ITEM'); ?>
			</a>
		</div>
	</div>
