...
<div class="transaction-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-transaction"
			  action="<?php echo JRoute::_('index.php?option=com_guitar&task=transaction.save'); ?>"
	...
	<?php foreach((array)$this->item->place as $value): ?>
		<?php if(!is_array($value)): ?>
			<input type="hidden" class="place" name="jform[placehidden][<?php echo $value; ?>]" value="<?php echo $value; ?>" />
		<?php endif; ?>
	<?php endforeach; ?>
	<?php echo $this->form->renderField('group'); ?>

	<?php foreach((array)$this->item->group as $value): ?>
		<?php if(!is_array($value)): ?>
			<input type="hidden" class="group" name="jform[grouphidden][<?php echo $value; ?>]" value="<?php echo $value; ?>" />
		<?php endif; ?>
	<?php endforeach; ?>				<div class="fltlft" <?php if (!JFactory::getUser()->authorise('core.admin','guitar')): ?> style="display:none;" <?php endif; ?> >
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-transaction").appendChild(input);
                    });
                </script>
             <?php endif; ?>
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_guitar&task=transactionform.cancel'); ?>"
