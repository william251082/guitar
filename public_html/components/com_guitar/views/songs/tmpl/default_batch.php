...
<div class="modal hide fade" id="collapseModal">
    <div class="modal-header">
        ...
        <h3>Choose Category to Copy Songs into</h3>
    </div>
        ...
        <div class="control-group">
            <div class="controls">
                ...
                >
                    ...
                    $categories = JHtml::_('category.options', 'com_guitar');
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('song.batch');">
