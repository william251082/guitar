...
<div class="group-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-group"
			  action="<?php echo JRoute::_('index.php?option=com_guitar&task=group.save'); ?>"
	...
	<?php endforeach; ?>				<div class="fltlft" <?php if (!JFactory::getUser()->authorise('core.admin','guitar')): ?> style="display:none;" <?php endif; ?> >
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_guitar&task=groupform.cancel'); ?>"
