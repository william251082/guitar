...
<div class="place-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-place"
			  action="<?php echo JRoute::_('index.php?option=com_guitar&task=place.save'); ?>"
	...
	<?php endforeach; ?>				<div class="fltlft" <?php if (!JFactory::getUser()->authorise('core.admin','guitar')): ?> style="display:none;" <?php endif; ?> >
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-place").appendChild(input);
                    });
                </script>
             <?php endif; ?>
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_guitar&task=placeform.cancel'); ?>"
