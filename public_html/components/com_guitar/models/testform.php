 ...
 * @since  1.6
 */
class GuitarModelTestForm extends JModelForm
{
    private $item = null;
    ...
    protected function populateState()
    {
        ...
        {
                $id = Factory::getApplication()->getUserState('com_guitar.edit.test.id');
        }
        else
        {
                $id = Factory::getApplication()->input->get('id');
                Factory::getApplication()->setUserState('com_guitar.edit.test.id', $id);
        }
     ...
     */
    public function getTable($type = 'Test', $prefix = 'GuitarTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_guitar.test', 'testform', array(
                        'control'   => 'jform',
                        'load_data' => $loadData
                )
        );
    ...
    {
        $data = Factory::getApplication()->getUserState('com_guitar.edit.test.data', array());
