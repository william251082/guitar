...
class ModInstagramHelper
{
	...
	{
		return JText::_(
			'MOD_INSTAGRAM_HEADER_FIELD_' . str_replace('#__', '', strtoupper($params->get('table'))) . '_' . strtoupper($field)
		);
	}
