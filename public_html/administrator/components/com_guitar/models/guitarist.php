 ...
 * @since  1.6
 */
class GuitarModelGuitarist extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_guitar.guitarist';
	...
	public function getForm($data = array(), $loadData = true)
	{
            ...
            // Get the form.
            $form = $this->loadForm(
                    'com_guitar.guitarist', 'guitarist',
                    array('control' => 'jform',
                            'load_data' => $loadData
                    )
            );
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guitar.edit.guitarist.data', array());
	...
	/**
	 * Method to duplicate an Guitarist
	 *
