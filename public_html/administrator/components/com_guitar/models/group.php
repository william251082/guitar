 ...
 * @since  1.6
 */
class GuitarModelGroup extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_guitar.group';
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guitar.edit.group.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__guitar_groups');
				$max             = $db->loadResult();
