...
/**
	...
	*/
	...
	protected function getListQuery()
	{
		...
		if ($filter_place !== null && !empty($filter_place))
		{
	...
	public function getItems()
	{
		...
		foreach ($items as $oneItem)
		{
			...
			if (isset($oneItem->place))
			{
				$values    = explode(',', $oneItem->place);
				$textValue = array();
				...
				$oneItem->place = !empty($textValue) ? implode(', ', $textValue) : $oneItem->place;
			}
		}
