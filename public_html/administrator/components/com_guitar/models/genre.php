 ...
 * @since  1.6
 */
class GuitarModelGenre extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_guitar.genre';
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guitar.edit.genre.data', array());
