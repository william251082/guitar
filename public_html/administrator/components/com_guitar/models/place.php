 ...
 * @since  1.6
 */
class GuitarModelPlace extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_guitar.place';
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guitar.edit.place.data', array());
