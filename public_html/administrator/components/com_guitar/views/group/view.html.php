 ...
 * @since  1.6
 */
class GuitarViewGroup extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_GUITAR_TITLE_GROUP'), 'group.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_guitar.group', $this->item->id);
		}
