 ...
 * @since  1.6
 */
class GuitarViewTests extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_GUITAR_TITLE_TESTS'), 'tests.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_guitar&view=tests');
	}
