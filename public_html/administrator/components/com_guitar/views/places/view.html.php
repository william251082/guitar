 ...
 * @since  1.6
 */
class GuitarViewPlaces extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		GuitarHelper::addSubmenu('places');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_GUITAR_TITLE_PLACES'), 'places.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_guitar&view=places');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`transaction`' => JText::_('COM_GUITAR_PLACES_TRANSACTION'),
			'a.`group`' => JText::_('COM_GUITAR_PLACES_GROUP'),
		);
	}
