 ...
 * @since  1.6
 */
class GuitarTableplace extends JTable
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_guitar.place.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_guitar/access.xml',
				"/access/section[@name='place']/"
			);
			$default_actions = JAccess::getAssetRules('com_guitar.place.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_guitar.place.' . (int) $this->$k;
	}
