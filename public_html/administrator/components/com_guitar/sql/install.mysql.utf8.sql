...
DROP TABLE IF EXISTS `#__guitar_guitarists`;
CREATE TABLE `#__guitar_guitarists` (
...
INSERT IGNORE INTO `#__guitar_songs` (`id`,`song_title`,`song_info`, `catid`) VALUES
