...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'director.cancel') {
			Joomla.submitform(task, document.getElementById('director-form'));
		}
		else {
			
			if (task != 'director.cancel' && document.formvalidator.isValid(document.id('director-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="director-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_MOVIES_TITLE_DIRECTOR', true)); ?>
		<div class="row-fluid">
