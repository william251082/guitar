 ...
 * @since  1.6
 */
class MoviesTablemovie extends JTable
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_movies.movie.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_movies/access.xml',
				"/access/section[@name='movie']/"
			);
			$default_actions = JAccess::getAssetRules('com_movies.movie.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_movies.movie.' . (int) $this->$k;
	}
