 ...
 * @since  1.6
 */
class MoviesModelDirector extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_movies.director';
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_movies.edit.director.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__movies_directors');
				$max             = $db->loadResult();
